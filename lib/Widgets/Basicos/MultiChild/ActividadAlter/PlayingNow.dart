...
import 'package:flutter_application_1/Widgets/Basicos/MultiChild/ActividadAlter/PlayingNowButton.dart';
    ...
    return Column(
      ...
      children: [
        Stack(
          ...
          children: [
            Image.asset("assets/images/qqqqqq.png",
                width: 270, fit: BoxFit.fitWidth),
            Image.asset(
              sound.cover,
              width: 200,
              height: 200,
